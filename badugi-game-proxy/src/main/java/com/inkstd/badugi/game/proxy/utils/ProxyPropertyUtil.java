...
public class ProxyPropertyUtil implements InitializingBean, FactoryBean<Properties> {
	private static final Logger LOGGER = LoggerFactory.getLogger(ProxyPropertyUtil.class);
	...
	public void setCompositeConfiguration(CompositeConfiguration compositeConfiguration) {
		synchronized (ProxyPropertyUtil.class) {
			ProxyPropertyUtil.compositeConfiguration = compositeConfiguration;
		}
	}
	...
	public void setLocalOverride(boolean localOverride) {
		synchronized (ProxyPropertyUtil.class) {
			ProxyPropertyUtil.localOverride = localOverride;
		}
	}
