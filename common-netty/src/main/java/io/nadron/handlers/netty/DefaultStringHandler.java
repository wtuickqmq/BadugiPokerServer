...
/**
 * This class will handle on the {@link GameEvent}s by forwarding message events
 * to the associated session instance.
 * 
 * @author Abraham Menacherry
 * 
 */
public class DefaultStringHandler extends SimpleChannelInboundHandler<String> {
	private static final Logger LOG = LoggerFactory.getLogger(DefaultStringHandler.class);
	...
	public DefaultStringHandler(PlayerSession playerSession) {
		super();
	...
	public void channelRead0(ChannelHandlerContext ctx, String msg) throws Exception {
		if (!"".equals(msg)&&!"\r\n".equals(msg)&&msg.startsWith("{")) {
			Event event = ObjectBeanUtil.JACKSON.readValue(msg, DefaultEvent.class);
