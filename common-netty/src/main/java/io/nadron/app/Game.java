...
public interface Game {
	 ...
	 */
	public <T> GameCommandInterpreter<T> getGameCommandInterpreter();
	 ...
	 */
	public <T> void setGameCommandInterpreter(GameCommandInterpreter<T> interpreter);

	/**
	 * Unloads the current game, by closing all sessions. This will delegate to
	 * {@link GameRoom#close()}
	 * 
	...
	void removeGameRoomByName(String gameRoomName);

	void removeGameRoomById(Long gameRoomId);

	void removeGameRoom(GameRoom room);

	void setGameRoom(Map<String, GameRoom> gameRoom);

	// public Map<String, GameRoom> getGameRoom();
	public boolean containsKey(Object key);

	public GameRoom getRoom(Object key);
