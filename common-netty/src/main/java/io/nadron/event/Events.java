...
public class Events {
	...
	public static final byte LOG_IN_WITH_JSON = 0x09;
	...
	public final static byte IDLESTATE = 0x25; // 37

	public final static byte PING = 0x26; // 38

	public final static byte SERVER_BUSYNESS = 0x27; // 39

	/**
	 * change the room var 
	 */
	public final static int ROOM_VARIABLE_CHANGE = 40; // 40
	...
	/**
	 * Creates a network event with the source set to the object passed in as
	 * parameter and the {@link DeliveryGuaranty} set to the incoming parameter.
	 * 
	 * @param source
	 *            The payload of the event. This is the actual data that gets
	 *            transmitted to remote machine.
