...
public class NettyTCPMessageSender implements Reliable
{
	...
	@Override
	public ChannelFuture sendMessage(Object message,GenericFutureListener<? extends Future<? super Void>>... listeners)
	{
		return channel.writeAndFlush(message).addListeners(listeners);
	}
