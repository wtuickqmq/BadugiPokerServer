 ...
 * 
 */
public interface GameAdminService<K>
{
	/**
	 ...
	 */
	public Object loadGame(K gameId, String gameName);
	 ...
	 */
	public Object unLoadGame(K gameId, String gameName);
	 ...
	 *         boolean suggesting success(true) or failure(false).
	 */
	public Object loadGameRoom(Game game, K gameRoomId, String gameRoomName);
	 ...
	 *         boolean suggesting success(true) or failure(false).
	 */
	public Object unloadGameRoom(Game game, K gameRoomId);
