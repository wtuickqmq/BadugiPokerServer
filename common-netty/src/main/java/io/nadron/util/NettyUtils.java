...
//		return new String(chars);
	...
	public static FullHttpResponse writeHttpResponse(ByteBuf buffer) {
		return writeHttpResponse(buffer, HttpResponseStatus.OK);
	}

	public static FullHttpResponse writeHttpResponse(ByteBuf buffer, HttpResponseStatus httpResponseStatus) {
		return writeHttpResponse("text/plain", buffer, httpResponseStatus);
	}

	public static FullHttpResponse writeHttpResponse(String type, ByteBuf buffer, HttpResponseStatus httpResponseStatus) {
		FullHttpResponse response = new DefaultFullHttpResponse(HTTP_1_1, httpResponseStatus, buffer);
