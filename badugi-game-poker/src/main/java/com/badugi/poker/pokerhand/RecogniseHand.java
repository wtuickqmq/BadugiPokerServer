...
public class RecogniseHand {
	...
	public static PokerHandBase recognise(final Card[] cardArr) {
		...
		// 高牌
		return new HighCard(cardArr[6], cardArr[5], cardArr[4], cardArr[3],
				cardArr[2]);
	}
	...
	public static void main(String[] arg) {
		...
		// }
		 ...
		 card1Arr[0] = Card.newCard(0);
		 card1Arr[1] = Card.newCard(5);
		 card1Arr[2] = Card.newCard(10);
		 card1Arr[3] = Card.newCard(13);
		 card1Arr[4] = Card.newCard(51);
		 card1Arr[5] = Card.newCard(1);
		 card1Arr[6] = Card.newCard(7);

		 Card[] card1Arr1 = new Card[7];
		 card1Arr1[0] = Card.newCard(47);
		 card1Arr1[1] = Card.newCard(40);
		 card1Arr1[2] = Card.newCard(33);
		 card1Arr1[3] = Card.newCard(44);
		 card1Arr1[4] = Card.newCard(10);
		 card1Arr1[5] = Card.newCard(35);
		 card1Arr1[6] = Card.newCard(32);
		 printCard(card1Arr);
		 ph = recognise(card1Arr);
		 System.out.println(ph.getPokerHandType());
		 ...
		 System.out.println(ph1.getCardStr());
	...
	private static List<Card> getTwoPairCards2(
		...
		if (cardArr[cardArr.length - 1].getValue() == cardArr[cardArr.length - 2]
				.getValue()) {
			licnew.add(cardArr[cardArr.length - 1]);
			licnew.add(cardArr[cardArr.length - 2]);
			if (cardArr[cardArr.length - 3].getValue() == cardArr[cardArr.length - 4]
					.getValue()) {
