 ...
 *
 */
public class DealerAccountVo implements Serializable{
	/**
	 * 
	 */
	...
	public DealerAccountVo(){}
	
	public DealerAccountVo(String cmd,String winPrizeItem,List<PlayerWinVo> winlist,List<WealthVo>	wealthlist,List<String> drawRecords){
		this.cmd = cmd;
