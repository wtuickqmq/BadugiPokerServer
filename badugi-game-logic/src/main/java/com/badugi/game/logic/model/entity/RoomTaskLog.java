...
/**
 * RoomTaskLog entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "room_task_log")
public class RoomTaskLog extends BaseEntity implements java.io.Serializable {
	...
	/** minimal constructor */
	public RoomTaskLog(Long fbid, Integer taskId, Integer requireNum1,
	...
	public RoomTaskLog(Long fbid, Integer taskId, Integer requireNum1,
			Integer gameCount, Integer requireNum2, Integer winGameCount,
			Short isFinal, Short isGetChips, Timestamp createTime) {
		this.fbid = fbid;
		this.taskId = taskId;
		this.requireNum1 = requireNum1;
		this.gameCount = gameCount;
