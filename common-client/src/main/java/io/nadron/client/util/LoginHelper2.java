...
public class LoginHelper2 {
	...
	protected LoginHelper2(LoginBuilder loginBuilder) {
		loginBuilder.validateAndSetValues();
		this.type = loginBuilder.type;
		this.parames = loginBuilder.parames;
	...
	public static class LoginBuilder {
		...
		public LoginBuilder parames(String parames) {
			this.parames = parames;
			return this;
		}

		public LoginBuilder type(int type) {
			this.type = type;
			return this;
		}
		...
		public LoginHelper2 build() {
			return new LoginHelper2(this);
		}
	...
	public MessageBuffer<ByteBuf> getLoginBuffer(InetSocketAddress localUDPAddress) throws Exception {
		...
		NettyUtils.writeStrings(username, password, connectionKey);
